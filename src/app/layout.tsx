...
export const metadata: Metadata = {
  title: "Matcha Amsterdam - Authentic Japanese Matcha",
  description: "Discover premium ceremonial-grade matcha from Amsterdam. Organic, hand-whisked, and direct from Japanese farms. Experience authentic matcha culture.",
  keywords: "matcha, Amsterdam, green tea, ceremonial grade, organic, Japanese tea",
  metadataBase: new URL("https://matchaamsterdam.nl"),
  alternates: {
    canonical: "https://matchaamsterdam.nl"
  },
  openGraph: {
    title: "Matcha Amsterdam - Authentic Japanese Matcha",
    description: "Premium ceremonial-grade matcha delivered fresh to Amsterdam. Experience authentic Japanese tea culture.",
    siteName: "Matcha Amsterdam",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Matcha Amsterdam - Premium Japanese Tea",
    description: "Authentic matcha culture in the heart of Amsterdam"
  }
};
